// Hệ thống phơi đồ, cửa sổ thông minh
...
#include <Servo.h>
 ...
 const int ldrpin = A2; //Chân đọc dữ liệu của cảm biến ánh sáng là chân analog số 0
 const int servopin = 9; //Chân kích xung để hoạt động servo là chân digital 8 trên board arduino
